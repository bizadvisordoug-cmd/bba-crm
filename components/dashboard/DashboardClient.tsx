    ...
    <div className="space-y-6 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="rounded-lg border p-4">
          <p className="text-base font-semibold text-white mb-2">Total Leads</p>
          <p className="text-3xl font-bold">{totalLeads}</p>
        </div>

        <div className="rounded-lg border p-4">
          <p className="text-base font-semibold text-white mb-2">Active Clients</p>
          <p className="text-3xl font-bold">{activeClients}</p>
        </div>

        <div className="rounded-lg border p-4">
          <p className="text-base font-semibold text-white mb-2">Tasks Due Today</p>
          <p className="text-3xl font-bold">{tasksDueToday.length}</p>
        </div>

        <div className="rounded-lg border p-4">
          <p className="text-base font-semibold text-white mb-2">Email Open Rate</p>
